...
function initSocialProof() {
    ...
    const messages = [
        '<strong>27 people</strong> bought in the last hour',
        '<strong>Juliana F.</strong> just bought!',
        '<strong>Patricia M.</strong> just bought!',
        '<strong>250 people</strong> bought in the last 24 hours',
        '<strong>Camila R.</strong> just bought!',
        '<strong>Renata S.</strong> just bought!',
        '<strong>170 people</strong> interested in buying in the last 10 hours',
        '<strong>Leticia G.</strong> just bought!',
        '<strong>Fernanda O.</strong> just bought!',
        '<strong>Beatriz C.</strong> just bought!',
        '<strong>Mariana P.</strong> just bought!',
        '<strong>7 people</strong> are viewing this offer now',
        '<strong>Amanda L.</strong> just bought!',
        '<strong>Priscylla K.</strong> just bought!'
    ];
